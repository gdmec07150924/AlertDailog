package com.example.administrator.alertdailog;
...
public class AlertDailog extends AppCompatActivity {
    ...
    private void dialog5() {
        ...
        ad.setButton(AlertDialog.BUTTON_POSITIVE,"取消",lis51);
        ad.show();
    }
    ...
    private void dialog7() {
        ...
        View layout = li.inflate(R.layout.edit,null);
